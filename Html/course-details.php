...
<body>
    ...
    $row = $allcourses->fetch_assoc();
    ?>
<div class="course-cont">
    <div class="course-img"><img src="<?php echo'../Admins/images/' . $row['image']; ?>" class="rounded mx-auto d-block" alt="..."></div>
    <div class="disc">
      <?php echo $row['name'];?>
      <br>
        Course Description:
    ...
    <a href="enroll.php?id=<?php echo $_GET['id'];?>" class="btn btn-primary enrol-btn">Enroll Now</a>
